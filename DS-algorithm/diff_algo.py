...
def main() :
    ...
    """
    for i in arr :
        print i.init_from_index,i.init_distance,i.final_distance,i.deleted_string,i.inserted_string
...
def main() :
    ...
    p1.init_from_index=int(raw_input())
    p1.init_distance=int(raw_input())
    p1.final_from_index=int(raw_input())
    p1.final_distance=int(raw_input())
    p1.pre_string=str(raw_input())
    p1.deleted_string=str(raw_input())
    p1.inserted_string=str(raw_input())
    p1.post_string=str(raw_input())

    p2.init_from_index=int(raw_input())
    p2.init_distance=int(raw_input())
    p2.final_from_index=int(raw_input())
    p2.final_distance=int(raw_input())
    p2.pre_string=str(raw_input())
    p2.deleted_string=str(raw_input())
    p2.inserted_string=str(raw_input())
    p2.post_string=str(raw_input())

    p3.init_from_index=int(raw_input())
    p3.init_distance=int(raw_input())
    p3.final_from_index=int(raw_input())
    p3.final_distance=int(raw_input())
    p3.pre_string=str(raw_input())
    p3.deleted_string=str(raw_input())
    p3.inserted_string=str(raw_input())
    p3.post_string=str(raw_input())
    original=str(raw_input())
    merge([p1,p2],[p3],original)
"""
